  ...
  en: {
    ...
    skills: {
      ...
      groups: [
        ...
        { name: "Security & Identity", items: ["Microsoft Entra ID", "SSO", "IAM", "Claims & Roles", "Endpoint Security", "Network Defense", "Threat Management"] },
  ...
  fr: {
    ...
    skills: {
      ...
      groups: [
        ...
        { name: "Sécurité & Identité", items: ["Microsoft Entra ID", "SSO", "IAM", "Claims & Rôles", "Sécurité des postes", "Défense réseau", "Gestion des menaces"] },
